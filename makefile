...
.DEFAULT_GOAL := help
.PHONY: greet blog calculator reader help 
project := greet calculator blog reader
...
clean: clean_greet clean_calculator clean_blog clean_reader## Clean generated files
	${RM_F_CMD} ssl/*.crt
	${RM_F_CMD} ssl/*.csr
	${RM_F_CMD} ssl/*.key
	${RM_F_CMD} ssl/*.pem
